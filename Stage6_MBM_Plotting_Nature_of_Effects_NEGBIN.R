...
# load("gam_nb_obj_Shots.Robj")

## REMEMBER: when excluding minute, it's in "TEST_gam.nb.obj" object, not "gam.nb.obj"

load(file=paste0(#ifelse(include.minute, "", "TEST_"),
                 "gam_nb_obj",  ifelse(remove.extra, "_NO_EXTRA_TIME", ""), "_Shots.Robj"))

# if (include.minute == FALSE){
#   gam.nb.obj <- TEST_gam.nb.obj
# }
...
adjusted_plots_shots <- adjusted_plots_shots[c(3, 2, 4, 1)]
...
load(file=paste0(#ifelse(include.minute, "", "TEST_"),
                 "gam_nb_obj",  ifelse(remove.extra, "_NO_EXTRA_TIME", ""), "_Corners.Robj"))
...
adjusted_plots_corners <- adjusted_plots_corners[c(3, 2, 4, 1)]
